...
class _LoginScreenState extends State<SigneUpScreen> {
  ...
  child: VerificationScreen(state.email,state.userName,state.phoneNumber,state.Address),
),));
    }
  },
            ...
            children: [
              ...
              Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      verticalSpace(16),  MyTextFormfield(
                        validation: (value){
                            if(value!.isEmpty  || !authCubit.regExp.hasMatch(value) ){
                      ...
                      verticalSpace(16),
                      MyTextFormfield(
                        validation:(value)  {if(value!.isEmpty || value.length<11 ){
              return 'phone number must be 11 char';
                    ...
                    authCubit.phoneNumber =value;
                      ...
                      verticalSpace(16),
                      MyTextFormfield(
                        validation: (value) {if(value!.isEmpty){
              return 'please write your address';
                ...
                authCubit.address=value;
                      ...
                      verticalSpace(20),
                      state is AuthCubitLoading? SpinKitCircle(color:Colors.black45):TextButton(
                        onPressed: () {
