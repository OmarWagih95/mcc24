...
// import 'package:MCC/cubits/mainPagecubit.dart';
...
//         if (state is BottomNavigationChange) {
//           final currentIndex = state.currentIndex;
//           return BottomNavigationBar(
//               type: BottomNavigationBarType.shifting,
//               selectedItemColor: ColorsManager.mainColor,
//               unselectedItemColor: ColorsManager.mainColor.withOpacity(.3),
//               currentIndex: (state as BottomNavigationChange).currentIndex,
//               onTap: (indx) => BlocProvider.of<BottomNavigationCubit>(context)
//                   .changeIndex(indx),
//               items: [
